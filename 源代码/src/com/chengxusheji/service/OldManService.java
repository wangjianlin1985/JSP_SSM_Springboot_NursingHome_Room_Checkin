...
public class OldManService {
    ...
    /*用户查询所有老人记录*/
    public ArrayList<OldMan> userQueryAllOldMan(String user_name)  throws Exception {
        return oldManMapper.queryOldManList("where 1=1 and t_oldMan.userObj='" + user_name + "' ");
    }
