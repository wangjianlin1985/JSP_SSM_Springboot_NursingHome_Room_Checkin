...
public interface RoomOrderMapper {
	...
	/*按照查询条件分页查询订单记录*/
	public ArrayList<RoomOrder> userQueryRoomOrder(@Param("where") String where,@Param("startIndex") int startIndex,@Param("pageSize") int pageSize) throws Exception;
	...
	/*按照查询条件的订单记录数*/
	public int userQueryRoomOrderCount(@Param("where") String where) throws Exception; 
