    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Reception/frontlist">接待记录</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="<%=basePath %>OldMan/oldMan_frontUserAdd.jsp"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;登记老人</a></li>
                        <li><a href="<%=basePath %>OldMan/frontUserlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我登记的老人</a></li>
                        <li><a href="<%=basePath %>RoomOrder/frontUserlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我申请的订单</a></li>
